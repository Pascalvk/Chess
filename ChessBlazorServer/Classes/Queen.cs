namespace ChessBlazorServer.Classes
{
    ...
    {
        public Queen(string name, string svgName, string color, int row, int col) : base(name, svgName, color, row, col)
        {
        ...
        {
            Queen clonedPiece = new Queen(this.Name, this.SVGName, this.Color, this.Position.Row, this.Position.Col)
            {
